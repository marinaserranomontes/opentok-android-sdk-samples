...
public class ReconnectionsActivity extends Activity implements
        Session.SessionListener, Publisher.PublisherListener,
        Subscriber.VideoListener, Session.ReconnectionListener, Subscriber.StreamListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(ReconnectionsActivity.this);
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, ReconnectionsActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearNotificationService.ClearBinder) binder).service.startService(new Intent(ReconnectionsActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            bindService(new Intent(ReconnectionsActivity.this,
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(ReconnectionsActivity.this,
    ...
    public void onConnected(Session session) {
        ...
        if (mPublisher == null) {
            mPublisher = new Publisher(ReconnectionsActivity.this, "publisher");
    ...
    private void subscribeToStream(Stream stream) {
        mSubscriber = new Subscriber(ReconnectionsActivity.this, stream);
