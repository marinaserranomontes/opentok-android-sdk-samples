...
public class StreamPrioritizationActivity extends Activity implements
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, StreamPrioritizationActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearNotificationService.ClearBinder) binder).service.startService(new Intent(StreamPrioritizationActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            bindService(new Intent(StreamPrioritizationActivity.this,
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(StreamPrioritizationActivity.this,
    ...
    public void onConnected(Session session) {
        ...
        if (mPublisher == null) {
            mPublisher = new Publisher(StreamPrioritizationActivity.this, "publisher");
    ...
    private void subscribeToStream(Stream stream) {
        mSubscriber = new Subscriber(StreamPrioritizationActivity.this, stream);
