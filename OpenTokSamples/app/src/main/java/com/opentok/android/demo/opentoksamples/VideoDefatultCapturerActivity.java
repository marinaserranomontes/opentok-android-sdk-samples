...
public class VideoDefatultCapturerActivity extends Activity implements
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, VideoDefatultCapturerActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearNotificationService.ClearBinder) binder).service.startService(new Intent(VideoDefatultCapturerActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            bindService(new Intent(VideoDefatultCapturerActivity.this,
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(VideoDefatultCapturerActivity.this,
    ...
    private void subscribeToStream(Stream stream) {
        mSubscriber = new Subscriber(VideoDefatultCapturerActivity.this, stream);
